...
<head>
    <title>Laporan Data Barang PT.RJSQ</title>
    <meta charset="utf-8">
...
$nomor=1;
    ...
    $group=$d->kategori_nama;
        ...
        <tr>
                ...
                <td style="vertical-align:center;padding-left:5px;text-align:center;"><?php echo $d->bid; ?></td>
                <td style="vertical-align:center;padding-left:5px;"><?php echo $d->bnama; ?></td>
                <td style="vertical-align:center;text-align:center;"><?php echo $d->bsatuan; ?></td>
                <td style="vertical-align:center;padding-right:5px;text-align:right;"><?php echo 'Rp '.number_format($d->bharga_jual); ?></td>
                <td style="vertical-align:center;text-align:center;text-align:center;"><?php echo $d->bstok; ?></td>  
        </tr>
